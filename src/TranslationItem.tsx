  ...
  return (
    <div className="TranslationItem">
      ...
      <div className="TranslationItem__header">
        ...
        {props.translationResult.date && <span title={props.translationResult.date.toString()} className="TranslationItem__header__date">{props.translationResult.date.toDateString()}</span>}
      </div>
      <ul>
